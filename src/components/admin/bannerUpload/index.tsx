...
//   const handleCorporateType = async (e: React.ChangeEvent<HTMLSelectElement>) => {
...
//       }
//     } else {
//       toast.error('please select corporate type ');
//     }
//   };
...
//                 <div className={styles.corporatetypeList}>
//                   <SelectField
//                     label="Corporate Type"
//                     name="corporateType"
//                     value={corporateType}
//                     // onChange={handleCorporateType}
//                     options={industryTypeOptions}
//                     // error={corporateTypeError}
...
//               {!isLoading ? (
//                 <>
//                   {corporateType !== '' && imagesDetails.length > 0
//                     ? // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
//               {corporateType === '' && (
//                 <>
//                   <div className="All_content_center flex-column w-100" style={{ marginTop: '25px', color: '#aaa' }}>
//                     <Image src={'/assets/svg/admin/image_not_found.svg'} alt="not found" width={150} height={150} />
//                     <h5 className="w-100 text-center" style={{ marginTop: '-25px' }}>
//                       You have to select corporate type
//                     </h5>
//                   </div>
//                 </>
//               )}
