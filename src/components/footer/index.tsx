  ...
  return (
    <section className={`${styles.footer_outter} element_center section_padding section_shadow`}>
      <div className={`${styles.footer_inner} element_center css_max_screen d-flex flex-wrap`}>
        <div className={`${styles.footer_1} element_center flex-wrap`}>
          <h2 className={`${styles.footer_heading} css-f25  text-white`}> Jhabak</h2>
        ...
        <div className={`${styles.footer_2} element_center  flex-wrap`}>
        ...
        <div className={`${styles.footer_3} element_center flex-wrap`}>
