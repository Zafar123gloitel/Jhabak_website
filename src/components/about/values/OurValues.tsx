  ...
  return (
    <>
      <div className={`${styles.basic_rule} element_center section_padding section_shadow w-100`}>
        <div className={`${styles.innr_basic_rule} css_max_screen d-flex flex-wrap`}>
          <div className={`${styles.our_values} element_center`}>
            ...
            <div className={`${styles.card_collection} element_center`}>
              <div className={`${styles.single_card} element_center`}>
